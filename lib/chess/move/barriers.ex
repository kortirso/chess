defmodule Chess.Move.Barriers do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      defp coordinates(move_from) do
        String.split(move_from, "", trim: true)
      end
      ...
      defp check_squares_for_barrier(_squares, _move_from, _route, _distance, _step) do
      end

      defp check_square(new_square, squares) do
        if squares[:"#{new_square}"] != nil do
          raise "There is barrier at square #{new_square}"
        end
      end
    end
  end
